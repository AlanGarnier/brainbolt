...
export const SignUpFormSchema = z.object({
    ...
    username: z.string({required_error: "Le nom d'utilisateur est requis"},).min(3, "Le nom d'utilisateur doit contenir au moins 3 caractères"), 
    image: z.string({ required_error: "L'image est requise" }).url({ message: "L'URL de l'image est invalide" })
});
