  ...
  return (
    <Section>
      ...
      <div className="flex flex-col mx-auto lg:max-w-[796px] space-y-[40px] items-center justify-center h-full text-center">
        <HeroTitle>Vivez une expérience de jeu fluide et rapide, conçue par des gamers pour des gamers.</HeroTitle>
        <HeroSubtitle>Découvrez notre service d'hébergement de jeux vidéo de pointe, conçu pour offrir des performances inégalées et une expérience de jeu coopératif fluide avec vos amis.
        </HeroSubtitle>
        <Button 
          asChild 
          className="glow">
